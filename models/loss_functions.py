...
class Semantic_loss_functions(object):
    ...
    def dice_loss_L1(self, y_true, y_pred):
        loss_dice = 1 - self.generalized_dice_coefficient(y_true, y_pred)
        L1 = K.abs(y_true - y_pred)
        loss = loss_dice + (L1*0.8)
        return loss
    ...
    def focal_tversky_L2(self, y_true, y_pred):
        B1 = 1
        B2 = 1
        
        focalT = self.focal_tversky(y_true, y_pred)
        L2 = self.L2(y_true, y_pred)
        
        loss = (B1*focalT) + (B2*L2)
        return loss 

    def focal_tversky_L1(self, y_true, y_pred):
        B1 = 0.1
        B2 = 0.75
